    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-6 font-sans">
            <div className="w-full max-w-md text-center mb-8">
                {/* Logo Area */}
                <div className="inline-flex items-center justify-center p-2 transition-transform hover:scale-105">
                    <img
                        src="/logo.png"
                        alt="VexFinance"
            ...
            {/* Login Card */}
            <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-8 lg:p-10 shadow-2xl shadow-slate-200/50">
                <div className="mb-8">
            ...
            <div className="mt-8 text-center text-slate-400 text-xs font-medium">
                &copy; 2026 VexFinance Inc. Todos os direitos reservados.
            </div>
        </div>
    );
};
